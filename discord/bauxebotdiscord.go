...
func init() {
	...
	var c cmd.Command
	c = cmd.CommandColor{Common: cmd.CommandCommon{Caller: "setcolor", Response: "Setting {NAME}'s color to {ARG1}.", Description: "Sets user's color", Structure: "!setcolor <color> (hex)", Channels: []string{}, RequiredPermissions: 0, RequiredUsers: []string{}}}
